...
const DEFINITIONS = {
  ...
  "semantic.foundation.inspect": definition(["semantic", "foundation"], [], "direct"),
  "semantic.candidates.inspect": definition(["semantic", "candidates"], ["hypothesis"], "direct"),
  "semantic.grounding.inspect": definition(["semantic", "ground"], ["candidateSet", "concepts", "expected", "priorResult"], "direct"),
  "semantic.compatibility.inspect": definition(["semantic", "compatibility"], ["requirements", "groundingResult"], "direct"),
  "semantic.reasoning-profile.inspect": definition(["semantic", "reasoning-profile"], ["file"], "direct"),
  "semantic.index.inspect": definition(["semantic", "index"], ["snapshot", "assets", "algorithm", "policy", "toolchain", "cache"], "direct"),
  "semantic.affected-subgraph.inspect": definition(["semantic", "affected-subgraph"], ["index", "profile", "changedConceptIds", "cacheDigest"], "direct"),
  "semantic.compute.inspect": definition(["semantic", "compute"], ["index", "profile", "mode", "affectedSubgraph", "externalReasonerResult", "execution"], "direct"),
  "semantic.compute.compare": definition(["semantic", "compare-computations"], ["incremental", "full"], "direct"),
  "semantic.federation.discover": definition(["semantic", "federate"], ["file"], "direct"),
  "semantic.interoperability.inspect": definition(["semantic", "interoperability"], ["file", "snapshot", "profile", "index"], "direct"),
  "semantic.round-trip.inspect": definition(["semantic", "round-trip"], ["snapshot", "projectionSet", "index", "incremental", "full"], "direct"),
  ...
  "pack.lifecycle.create": definition(["pack", "lifecycle-init"], ["file", "pack"], "session"),
  "pack.lifecycle.transition": definition(["pack", "transition"], ["record", "transition", "actor", "actorRole", "expectedRecordDigest", "reason", "successor", "rollbackTarget", "migrationPlan", "now"], "session"),
  "pack.benchmark.inspect": definition(["pack", "benchmark"], ["file"], "direct"),
  "pack.gold-case.inspect": definition(["pack", "gold-case"], ["file"], "direct"),
  "pack.certification.inspect": definition(["pack", "certify"], ["file", "pack"], "direct"),
  "semantic.evidence-adapter.inspect": definition(["pack", "evidence-adapter"], ["file"], "direct"),
  "semantic.evidence.import.inspect": definition(["pack", "import-evidence"], ["file"], "direct"),
  "project-ontology.proposal.inspect": definition(["project-ontology", "propose"], ["file"], "direct"),
  "project-ontology.proposal.transition": definition(["project-ontology", "transition"], ["proposal", "transition", "actor", "expectedProposalDigest", "reason", "now"], "session"),
  "project-ontology.snapshot.resolve": definition(["project-ontology", "resolve"], ["proposal", "expectedProposalDigest", "foundationDigest", "priorSnapshot", "now"], "direct"),
  "project-ontology.projections.inspect": definition(["project-ontology", "project"], ["snapshot"], "direct"),
  "project-ontology.skill.inspect": definition(["project-ontology", "skill"], ["snapshot", "artifactSetManifestDigest"], "direct"),
  "project-ontology.artifact.publish": definition(["project-ontology", "publish"], ["snapshot", "publication", "dependencyLock"], "publication"),
  "project-ontology.artifact.transition": definition(["project-ontology", "artifact-transition"], ["artifactSet", "record", "transition", "actor", "actorRole", "expectedRecordDigest", "reason", "successor", "rollbackTarget", "migrationPlan", "now"], "session"),
  "policy.inspect": definition(["policy", "inspect"], ["file", "type"], "direct"),
  "policy.validate": definition(["policy", "validate"], ["file", "type"], "direct"),
  "policy.diff": definition(["policy", "diff"], ["left", "right", "type"], "direct"),
  "policy.publish": definition(["policy", "publish"], ["file", "type"], "publication"),
  ...
  "comparison.inspect": definition(["comparison", "inspect"], ["file"], "direct", "file"),
  "comparison.validate": definition(["comparison", "validate"], ["file", "now"], "direct", "file"),
  "comparison.ingest": definition(["comparison", "ingest"], ["file", "now"], "planned", "file"),
  "comparison.process": definition(["comparison", "process"], ["file", "now", "policyFile"], "planned", "file"),
  "comparison.score": definition(["comparison", "score"], ["comparisonId", "now", "policyFile"], "planned", "comparisonId"),
  "comparison.report": definition(["comparison", "report"], ["reportId"], "direct", "reportId"),
  "comparison.rescore": definition(["comparison", "rescore"], ["reportId", "policyFile", "reason", "now"], "planned", "reportId"),
  "calibration.validate": definition(["calibration", "validate"], ["file"], "direct", "file"),
...
const OPTION_NAMES = {
  ...
  assets: "asset",
  changedConceptIds: "changed-concept",
  cacheDigest: "cache-digest",
  affectedSubgraph: "affected-subgraph",
  externalReasonerResult: "external-reasoner-result",
  projectionSet: "projection-set",
  roundTripReport: "round-trip-report",
  harnessAssets: "harness-asset",
  conceptIds: "concept-id",
  expectedClosureDigest: "expected-closure-digest",
  packs: "pack",
  availablePacks: "available-pack",
  targetRoot: "target-root",
  expectedBaseDigest: "expected-base-digest",
  expectedRecordDigest: "expected-record-digest",
  expectedProposalDigest: "expected-proposal-digest",
  foundationDigest: "foundation-digest",
  priorSnapshot: "prior-snapshot",
  artifactSet: "artifact-set",
  artifactSetManifestDigest: "artifact-set-manifest-digest",
  entryIds: "entry-ids",
