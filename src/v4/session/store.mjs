...
export function inspectAgentSession(home, sessionId) {
  ...
  if (!["4.5.0", "4.6.0", "4.7.0", "4.8.0"].includes(session.compatibility?.productVersion)) throw sessionError("PRE_V45_SESSION_UNSUPPORTED", "The Agent Operation Session predates the fresh v4.5.0 representation baseline and will not be read or migrated.", "start-fresh-v4.5-session");
