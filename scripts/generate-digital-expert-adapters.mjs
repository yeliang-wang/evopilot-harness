...
const copiedSchemas = ["agent-operation-session-v1.schema.json", "agent-operation-session-v2.schema.json", "agent-operation-session-v3.schema.json", "classification-session-v1.schema.json", "classification-analysis-receipt-v1.schema.json", "classification-handoff-v1.schema.json", "classification-evaluation-report-v1.schema.json", "source-descriptor-v1.schema.json", "taxonomy-v1.schema.json", "resolved-taxonomy-snapshot-v1.schema.json", "source-concept-hypothesis-v1.schema.json", "taxonomy-analysis-result-v1.schema.json", "ontology-foundation-v1.schema.json", "semantic-candidate-set-v1.schema.json", "ontology-grounding-result-v1.schema.json", "harness-semantic-requirements-v1.schema.json", "semantic-compatibility-report-v1.schema.json", "professional-pack-v1.schema.json", "professional-pack-inspection-v1.schema.json", "resolved-professional-pack-set-v1.schema.json", "pack-lifecycle-record-v1.schema.json", "pack-benchmark-v1.schema.json", "pack-gold-case-v1.schema.json", "pack-certification-v1.schema.json", "external-semantic-evidence-adapter-v1.schema.json", "external-semantic-evidence-v1.schema.json", "project-ontology-proposal-v1.schema.json", "resolved-project-ontology-snapshot-v1.schema.json", "project-ontology-projection-set-v1.schema.json", "project-ontology-skill-v1.schema.json", "project-ontology-artifact-set-v1.schema.json", "project-ontology-artifact-lifecycle-v1.schema.json", "ontology-reasoning-profile-v1.schema.json", "semantic-index-v1.schema.json", "affected-subgraph-v1.schema.json", "semantic-computation-v1.schema.json", "federated-pack-discovery-v1.schema.json", "semantic-interoperability-projection-set-v1.schema.json", "semantic-round-trip-report-v1.schema.json", "terminal-semantic-closure-v1.schema.json", "terminal-semantic-slice-v1.schema.json", "interaction-frame-v1.schema.json", "interaction-frame-v2.schema.json", "business-decision-view-v1.schema.json", "compliance-audit-envelope-v1.schema.json", "source-to-harness-reasoning-map-v1.schema.json", "harness-professional-analysis-v1.schema.json", "harness-architecture-assessment-v1.schema.json", "source-outcome-explanation-v1.schema.json", "evolution-context-binding-v1.schema.json", "agent-host-boundary-contract-v1.schema.json", "host-conformance-profile-v1.schema.json", "canonical-presentation-delivery-receipt-v1.schema.json", "decision-definition-v1.schema.json", "operation-plan-v1.schema.json"];
