...
for (const expectedPath of ["src/index.mjs", "src/v3/reasoning.mjs", "src/v3/review.mjs", "assets/v3/components/engineering-validation/asset.yaml", "schemas/harness-asset-v3.schema.json", "schemas/proposal-review-v1.schema.json", "schemas/proposal-semantic-review-v1.schema.json", "ontology/builtin/software-engineering.yaml", "policies/matcher/default.yaml", "policies/advisor/default.yaml", ".agents/skills/evopilot-harness-guided-operator/SKILL.md", "ui/harness-hub/index.html", "published/CATALOG.md", "docs/assets/harness-hub.png", "AGENTS.md", "CONTRIBUTING.md", "SECURITY.md", "LICENSE", "llms.txt", "Dockerfile", "compose.yaml"]) {
