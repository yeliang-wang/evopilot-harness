...
for (const expectedPath of ["src/index.mjs", "src/v3/reasoning.mjs", "src/v3/review.mjs", "src/v3/feedback.mjs", "assets/v3/components/engineering-validation/asset.yaml", "schemas/harness-asset-v3.schema.json", "schemas/harness-execution-feedback-package-v1.schema.json", "schemas/harness-effectiveness-report-v1.schema.json", "schemas/evaluation-pack-v2.schema.json", "schemas/proposal-review-v1.schema.json", "schemas/proposal-semantic-review-v1.schema.json", "ontology/builtin/software-engineering.yaml", "policies/matcher/default.yaml", "policies/advisor/default.yaml", "governance/roadmap.yaml", "docs/roadmap/ROADMAP.md", ".agents/skills/evopilot-harness-guided-operator/SKILL.md", "ui/harness-hub/index.html", "published/CATALOG.md", "docs/guides/feedback-evidence.md", "docs/assets/harness-hub.png", "AGENTS.md", "CONTRIBUTING.md", "SECURITY.md", "LICENSE", "llms.txt", "Dockerfile", "compose.yaml"]) {
