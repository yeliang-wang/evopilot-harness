...
```bash
npm view @evopilot/harness@4.5.0 name version dist-tags dist.integrity dist.signatures dist.attestations --json
```
...
npm init -y
npm install --ignore-scripts --no-audit --no-fund @evopilot/harness@4.2.0
