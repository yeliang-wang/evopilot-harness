...
| CLI | Catalog publication, source scanning, auto-match, draft generation, review gates, approval, and publication. |
...
flowchart TD
  ...
  B --> C["Auto-match existing Harness or create new id"]
