...
3. Should the evidence evolve an existing Profile, compose a Bundle, propose a new Profile, or stop?
...
|---|---|---|
| Engine | `evopilot-harness@3.2.0` | CLI, schemas, algorithms, UI, or runtime code changes. |
...
| Policy | `default-advisor@1.2.0` | Weights, thresholds, risk rules, Advisor contract, or Proposal Review contract changes. |
