...
The v2 CLI, source packs, Harness Asset envelope, Catalog, and Registry remain available as a compatibility layer in Engine `3.1.0`. They are not the canonical v3 asset model.
