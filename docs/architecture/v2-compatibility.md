...
The v2 CLI, source packs, Harness Asset envelope, Catalog, and Registry remain available as a compatibility layer in Engine `4.0.2`. EvaluationPack v1 and v2 remain readable while new Proposals use EvaluationPack v3. These legacy surfaces are not the canonical v3 asset and Delta model.
