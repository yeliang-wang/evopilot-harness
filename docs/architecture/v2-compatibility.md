...
The v2 CLI, source packs, Harness Asset envelope, Catalog, and Registry remain available as a compatibility layer in Engine `3.2.1`. They are not the canonical v3 asset model.
