...
- [v4.8.0 Acceptance Closure](operations/v4.8.0-acceptance.md) - 22 current criteria, 247 inherited criteria, RC01–RC05, incremental/full equivalence, federation, package, Host, and no-regression evidence.
