...
> The canonical v3 schema is the Component/Profile/Bundle model in [v3 Asset Model](../architecture/v3-asset-model.md) and [`schemas/harness-asset-v3.schema.json`](../../schemas/harness-asset-v3.schema.json). This page documents the legacy EvoPilot-compatible template projection.
